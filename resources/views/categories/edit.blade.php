            ...
            <div class="bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg border border-gray-700">
                <div class="p-8 text-gray-100">
                    ...
                    <div class="mb-8">
                        ...
                        <p class="text-gray-400 text-sm mt-1 ml-8">Update the details of your category.</p>
                    </div>

                    <form action="{{ route('categories.update', $category->id) }}" method="POST" class="ml-8">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="mb-8">
                            ...
                            <input type="text" name="name" value="{{ old('name', $category->name) }}" class="w-full bg-gray-900 border border-gray-700 text-white rounded-lg py-2.5 px-4 focus:outline-none focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 placeholder-gray-500">
                            @error('name')
